...
from ._matplotlib_backend import (
    ...
    plot_feature_drift_matplotlib,
    plot_multiple_features,
)
from ._plotly_backend import plot_drift_values, plot_feature_drift_plotly
...
class DriftPlotter:
    ...
    def plot_feature_drift(
        ...
        """
        return plot_feature_drift_plotly(
            reference=reference,
            current=current,
    ...
    def plot_feature_drift_mp(
        ...
        """
        return plot_feature_drift_matplotlib(
            reference=reference,
            current=current,
            feature_name=feature_name,
            show_score=show_score,
